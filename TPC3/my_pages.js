			...
			<div class="w3-card">
				...
				<ul class="w3-ul w3-large w3-hoverable">
					<li class="w3-padding-medium">
						<a href="http://localhost:12345/pessoas/">
							Lista de Pessoas 
						</a>
					</li>
					<li class="w3-padding-medium"> 
						<a href="http://localhost:12345/pessoas/ord">
							Lista de Pessoas Ordenadas
						</a>
					</li>
					<li class="w3-padding-medium">
						<a href="http://localhost:12345/pessoas/sexo">
							Distribuição por Sexo
						</a>
					</li>
					<li class="w3-padding-medium">
						<a href="http://localhost:12345/pessoas/desporto">
							Distribuição por Desporto
						</a>
					</li>
					<li class="w3-padding-medium">
						<a href="http://localhost:12345/pessoas/profissoes">
							Top 10 Profissões
						</a>
					</li>
				</ul>
			...
			<div class="w3-card">
				...
				<table class="w3-table-all w3-hoverable">
					<tr>
						<th>Id</th>
						<th>
							<a href="http://localhost:12345/pessoas/${id}">
								Nome
							</a>
						</th>
						<th>Idade</th>
	...
	Object.keys(dist).forEach( (key) => {
		pagHTML += `
						<tr>
							<td>${key}</td>
							<td>
								<a href="http://localhost:12345/pessoas/desporto/${key}">
									${dist[key]}
								</a>
							</td>
						</tr>
